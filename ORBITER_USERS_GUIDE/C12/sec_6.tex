...
Apart from the header and footer, 
each row in the file describes exactly one geometry.
...
The next command classifies the nonexistence of a pair of orthogonal Latin squares of order 6 (Euler's problem).

\sourcecode{geo_MOL6.inc}

No geometry is found, proving that no MOL(6) exists.
