...
Consider the $k$-subsets of an $n$-set. The following example creates the $3$-subsets of a $6$-set 
in lexicographic order. A tree representation is produced.  The leaves of the tree represent the subsets:
...
below
\orbiteroutput{GRAPHICS/WRAPPERS/domino_anton}
...
\orbiteroutput{GRAPHICS/WRAPPERS/domino_anton_28x32_draw}
