...
\hline
\verb'-singer_and_frobenius' & $k$ & subgroup of index $k$ in the Singer cycle, 
...
\hline
\verb'-subgroup_by_generators' & $l$ $o$ $n$ $s_1$ $\ldots$ $s_n$ & 
Generate a subgroup from generators. 
The label ``l'' is used to denote the subgroup; 
$o$ is the order of the subgroup; 
