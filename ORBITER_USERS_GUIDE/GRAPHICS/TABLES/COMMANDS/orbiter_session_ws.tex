...
\hline
\hline
\verb'-v'  &  $v$  &  Set verbosity to $v$. Larger values of $v$ lead to more text output. $v=0$ gives minimal to no output. \\
\hline
\verb'-list_arguments'  &   & Print the command line arguments. \\
\hline
...
\hline
\verb'-override_polynomial'  &  poly  &  Specify the override polynomial for the creation on finite fields. See Section~\ref{sec:extension:fields}. \\
\hline
