\begin{table}[t]
\tbl{\label{tab:finitefield:activities:more}}
...
\hline
\verb'-nth_roots'  &  $n$   & Compute the minimum polynomials of all $n$-th roots over $F$.\\
\hline
\verb'-field_reduction'  &  label $q$ $m$ $n$ $v$  & Compute the field reduction from $F$ to the subfield $\bbF_q$ of the $m \times n$ matrix whose coefficients are given in $v$.  \\
\hline
\end{tcolorbox}}
\end{table}
