...
\hline
\hline
\verb'-paperheight' &  h  & Set paperheight for the latex document. 
The given value is measures the paperheight in tens of an inch. \\
\hline
\verb'-paperwidth' &  w  & Set paperwidth for the latex document. 
The given value is measures the paperwidth in tens of an inch. \\
\hline
...
\hline
\verb'-label_edges' &   & Label the edges. This option is relevant for the drawing of Schreier trees. 
Default value: off. \\
\hline
