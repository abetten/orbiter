...
\input Perm4_sims_0.tex

Basic orbit 0 has size 4\\
0, 1, 2, 3\\
\bigskip

\subsection*{Basic Orbit 1}

\input Perm4_sims_1.tex

Basic orbit 1 has size 3\\
1, 2, 3\\
\bigskip

\subsection*{Basic Orbit 2}

\input Perm4_sims_2.tex

Basic orbit 2 has size 2\\
2, 3\\
\bigskip
