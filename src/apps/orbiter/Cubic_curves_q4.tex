...
\subsection*{Cubic Curves in PG$(2,4)$}
The order of the group is 120960\\
\bigskip
The group has 0 orbits: \\
The overall number of objects is: 0\\
summary of the stabilizer orders:\\
Families 1, 2, 3, E, H: \\
e=0 iso1=-1 iso2=-1 iso3=-1 isoE=-1 isoH=-1 \\
e=1 iso1=-1 iso2=-1 iso3=-1 isoE=-1 isoH=-1 \\
e=2 iso1=-1 iso2=-1 iso3=-1 isoE=-1 isoH=-1 \\
e=3 iso1=-1 iso2=-1 iso3=-1 isoE=-1 isoH=-1 \\
c=1 d=1 isoG=-1 \\
c=1 d=2 isoG=-1 \\
c=1 d=3 isoG=-1 \\
c=2 d=1 isoG=-1 \\
...
Distribution: $()$\\
$$
\begin{array}{|c||c|c|c|c|c|}\hline\mbox{Curve} & \mbox{Ago} & \mbox{Pts} & \mbox{s. Pts} & \mbox{Infl} & \mbox{References} \\\hline\hline\end{array}
$$
with canonical forms 
\begin{eqnarray*}
F1_e &=& X^2Y + XY^2 + eZ^3 \\
F2_e &=& X^2Y + XY^2 + XYZ + eZ^3 \\
F3_e &=& XYZ + e(X + Y + Z)^3 \\
E_d &=& Z^2Y + X^3 - dY^3 \\
H_e &=& Z^2Y + X^3 + eXY^2 \\
G_{c,d} &=&  Z^2Y + X^3 + cXY^2 + dY^3 \\
\end{eqnarray*}
for $c,d,e \in {\mathbb F}_{4}$ \\
