		...
		std::ostream &ost, int verbose_level)
{
	...
	ost << "The following table shows the conjugacy "
			"classes of the group. The columns display: "
			...
			"the order of the normalizer of the group generated "
			"by an element of the class.\\\\" << endl;
