...
#include "DATA/quartic_curves/quartic_curves_q37.cpp"
...
int knowledge_base::quartic_curves_nb_reps(
		int q)
{
	int nb;
...
int *knowledge_base::quartic_curves_representative(
		int q, int i)
// i starts from 0
{
	int *p, nb, sz;
	...
	if (q == 9) {
		...
		p = quartic_curves_q11_reps;
		nb = quartic_curves_q11_nb_reps;
		sz = quartic_curves_q11_size;
	}
	else if (q == 13) {
		...
		p = quartic_curves_q37_reps;
		nb = quartic_curves_q37_nb_reps;
		sz = quartic_curves_q37_size;
	}
	else if (q == 41) {
		p = quartic_curves_q41_reps;
		nb = quartic_curves_q41_nb_reps;
...
long int *knowledge_base::quartic_curves_bitangents(
		int q, int i)
// i starts from 0
{
	long int *p;
	...
	if (q == 9) {
		...
		p = quartic_curves_q11_Bitangents;
		nb = quartic_curves_q11_nb_reps;
	}
	else if (q == 13) {
		...
		p = quartic_curves_q37_Bitangents;
		nb = quartic_curves_q37_nb_reps;
	}
	else if (q == 41) {
...
void knowledge_base::quartic_curves_stab_gens(
		int q, int i,
		int *&data, int &nb_gens, int &data_size, std::string &stab_order_str)
{
	...
	if (q == 9) {
		...
		Reps = quartic_curves_q11_stab_gens;
		nb = quartic_curves_q11_nb_reps;
		make_element_size = quartic_curves_q11_make_element_size;
		f = quartic_curves_q11_stab_gens_fst[i];
		l = quartic_curves_q11_stab_gens_len[i];
		stab_order = quartic_curves_q11_stab_order[i];
	}
	else if (q == 13) {
		...
		Reps = quartic_curves_q37_stab_gens;
		nb = quartic_curves_q37_nb_reps;
		make_element_size = quartic_curves_q37_make_element_size;
		f = quartic_curves_q37_stab_gens_fst[i];
		l = quartic_curves_q37_stab_gens_len[i];
		stab_order = quartic_curves_q37_stab_order[i];
	}
	else if (q == 41) {
		Reps = quartic_curves_q41_stab_gens;
		nb = quartic_curves_q41_nb_reps;
		make_element_size = quartic_curves_q41_make_element_size;
...
int *knowledge_base::cubic_surface_representative(
		int q, int i)
// i starts from 0
{
	int *p, nb, sz;
...
void knowledge_base::cubic_surface_stab_gens(
		int q, int i,
		int *&data, int &nb_gens, int &data_size, std::string &stab_order_str)
{
	int *Reps;
...
int knowledge_base::cubic_surface_nb_Eckardt_points(
		int q, int i)
// i starts from 0
{
	int *p, nb; //, sz;
...
long int *knowledge_base::cubic_surface_Lines(
		int q, int i)
// i starts from 0
{
	long int *p, nb;
...
int knowledge_base::hyperoval_nb_reps(
		int q)
{
	int nb;
...
int *knowledge_base::hyperoval_representative(
		int q, int i)
// i starts from 0
{
	int *p, nb, sz;
...
void knowledge_base::hyperoval_gens(
		int q, int i,
		int *&data, int &nb_gens, int &data_size, std::string &stab_order_str)
{
	int *Reps;
...
long int *knowledge_base::DH_representative(
		int k, int n, int i)
// i starts from 0
{
	long int *p, nb, sz;
...
void knowledge_base::DH_stab_gens(
		int k, int n, int i,
		int *&data, int &nb_gens, int &data_size, std::string &stab_order_str)
{
	int *Reps;
...
int knowledge_base::Spread_nb_reps(
		int q, int k)
{
	int nb;
...
long int *knowledge_base::Spread_representative(
...
void knowledge_base::Spread_stab_gens(
		int q, int k, int i,
		int *&data, int &nb_gens, int &data_size, std::string &stab_order_str)
{
	int *Reps;
...
int knowledge_base::BLT_nb_reps(
		int q)
{
	int nb;
...
long int *knowledge_base::BLT_representative(
		int q, int no)
// i starts from 0
{
	long int *p;
...
void knowledge_base::BLT_stab_gens(
		int q, int no,
		int *&data, int &nb_gens, int &data_size, std::string &stab_order_str)
{
	int *Reps;
...
void knowledge_base::override_polynomial_subfield(
...
void knowledge_base::override_polynomial_extension_field(
		std::string &poly, int q)
{
	const char *override_poly = NULL;
	int p, h;
...
int knowledge_base::tensor_orbits_nb_reps(
		int n)
{
	int nb;
...
long int *knowledge_base::tensor_orbits_rep(
		int n, int idx)
// idx starts from 0
{
	long int *p;
