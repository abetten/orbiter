...
// this function creates a finite field, using the given polynomial if necessary
{
	...
	int p, e, m, r, i;
	algebra::ring_theory::longinteger_object Qm1, Index;
	...
	algebra::ring_theory::unipoly_object beta, beta_i, c;
	...
	algebra::ring_theory::unipoly_domain FpX(&Fp);
	string field_poly;
	...
	algebra::ring_theory::unipoly_domain Fq(&Fp, M, verbose_level);  // Fq = Fp[X] modulo factor polynomial M
	if (f_vv) {
		cout << "cyclic_codes::make_cyclic_code "
	...
	algebra::ring_theory::unipoly_object *generator = NEW_OBJECTS(algebra::ring_theory::unipoly_object, degree + 2);
	algebra::ring_theory::unipoly_object *tmp = NEW_OBJECTS(algebra::ring_theory::unipoly_object, degree + 1);
	algebra::ring_theory::unipoly_object *coeffs = NEW_OBJECTS(algebra::ring_theory::unipoly_object, 2);
	algebra::ring_theory::unipoly_object Pc, Pd;
	...
	int verbose_level)
{
	...
	algebra::ring_theory::unipoly_object c, beta, beta_i;
	algebra::ring_theory::longinteger_object *beta_rk_table, rk;
	int i, j;


	beta_rk_table = NEW_OBJECTS(algebra::ring_theory::longinteger_object, q);
	...
	int verbose_level)
{
	...
	int p = F->q;
	int e, i, j, r;
	algebra::ring_theory::longinteger_object q, b, m1, qm1;
	algebra::ring_theory::longinteger_domain D;
	algebra::number_theory::number_theory_domain NT;
	...
	string field_poly;
	algebra::ring_theory::unipoly_object m, M, h1, h2;
	knowledge_base::knowledge_base K;
	...
	algebra::ring_theory::unipoly_domain Fq(F, M, verbose_level - 1);
	algebra::ring_theory::unipoly_object beta, beta_i, c;
	if (f_vvv) {
	...
	algebra::ring_theory::longinteger_object *beta_rk_table = NEW_OBJECTS(algebra::ring_theory::longinteger_object, n);
	algebra::ring_theory::longinteger_object ai, bi;
	...
	rank_of_irreducibles = NEW_OBJECTS(
			algebra::ring_theory::longinteger_object, transversal_length);
...
void cyclic_codes::compute_generator_matrix(
		algebra::ring_theory::unipoly_object a, int *&genma, int n, int &k,
		int verbose_level)
{
	int f_v = (verbose_level >= 1);
	int *r = (int *) a;
