	...
	int verbose_level)
{
	...
	int *H;
	int *AA;
	algebra::linear_algebra::representation_theory_domain Rep;
	...
	int verbose_level)
{
	...
	algebra::ring_theory::unipoly_domain FqX(&F);
	algebra::ring_theory::unipoly_object gen, Xnm1, quo, rem, h, Xma;
	...
	algebra::ring_theory::unipoly_domain FQQX(&FQQ);
	...
	int verbose_level)
{
	...
	algebra::linear_algebra::representation_theory_domain RF;
