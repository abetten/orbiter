		...
		int verbose_level)
{
	...
	algebra::ring_theory::longinteger_object A, M;
		...
		int verbose_level)
{
	...
	algebra::ring_theory::unipoly_domain FX(Fq);
	algebra::ring_theory::unipoly_object H, R, Msg, M, C, D;
		...
		int verbose_level)
{
	...
	algebra::ring_theory::unipoly_object A;
		...
		int p, int a, int verbose_level)
{
	...
	algebra::ring_theory::longinteger_object P, A;
		...
		int factorbase, int x0, int verbose_level)
{
	...
	algebra::ring_theory::longinteger_object M, sqrtM;
	algebra::ring_theory::longinteger_domain D;
	algebra::number_theory::number_theory_domain NT;
	...
	while (true) {
		...
		algebra::ring_theory::longinteger_object P, Q;
		...
		int verbose_level)
{
	...
	int i, l, r, s, p;
	algebra::ring_theory::longinteger_domain D;
	algebra::ring_theory::longinteger_object Q, R, P;
...
// Due to reduce primes, the polynomial factors mod p.
{
	...
	int r1, r2, c, c2, s;
	algebra::ring_theory::longinteger_domain D;
	algebra::ring_theory::longinteger_object P, l1, l2, l3;
	...
	int verbose_level)
{
	...
	int x, j;
	algebra::ring_theory::longinteger_domain D;
	algebra::ring_theory::longinteger_object Z, zero, a, b, c, d;
	int i, l;
...
{
	algebra::ring_theory::longinteger_domain D;
	algebra::ring_theory::longinteger_object y, z1, residue;
	int i, l, n, p;
	...
	int verbose_level)
{
	...
	algebra::ring_theory::longinteger_domain D;
	algebra::ring_theory::longinteger_object b, one;
	int i = 0;
...
int cryptography_domain::solovay_strassen_is_prime_single_test(
		algebra::ring_theory::longinteger_object &n, int verbose_level)
{
	int f_v = (verbose_level >= 1);
	int f_vv = (verbose_level >= 2);
	algebra::ring_theory::longinteger_domain D;
	algebra::ring_theory::longinteger_object a, one, b, m_one, n_minus_one;
	int r;
...
// returns true is the test is conclusive, i.e. if the number is not prime.
{
	int f_v = (verbose_level >= 1);
	algebra::ring_theory::longinteger_domain D;
	algebra::ring_theory::longinteger_object A, B, one, minus_two, n_minus_two;
	int i, ret;
	...
	int verbose_level)
{
	...
	int f_vv = (verbose_level >= 2);
	algebra::ring_theory::longinteger_domain D;
	algebra::ring_theory::longinteger_object b, one, m_one, n2, n_minus_one;
...
// returns true is the test is conclusive, i.e. if the number is not prime.
{
	...
	//int f_vv = (verbose_level >= 2);
	algebra::ring_theory::longinteger_domain D;
	algebra::ring_theory::longinteger_object A, B, one, m_one, m_two, P_minus_one, P_minus_two;
	int i, ret;
		...
		int verbose_level)
{
	...
	int f_vv = (verbose_level >= 2);
	algebra::ring_theory::longinteger_domain D;
	algebra::ring_theory::longinteger_object a, b, c, one, m_one, n_minus_one, m, mm;
	int k, i;
...
int cryptography_domain::miller_rabin_test_with_latex_key(
		std::ostream &ost,
		algebra::ring_theory::longinteger_object &n, int iteration,
		int verbose_level)
{
	int f_v = (verbose_level >= 1);
	int f_vv = (verbose_level >= 2);
	...
	int verbose_level)
{
	...
	int f_vv = (verbose_level >= 2);
	algebra::ring_theory::longinteger_domain D;
	algebra::ring_theory::longinteger_object m1, pm1, qm1, phi_n, v, g;
