...
int arc_basic::OKeefe_Penttila_32(
		int t)
...
int arc_basic::LunelliSce_evaluate_cubic1(
		int *v)
...
int arc_basic::LunelliSce_evaluate_cubic2(
		int *v)
