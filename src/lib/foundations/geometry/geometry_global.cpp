...
void geometry_global::arc_lifting1(
		projective_space *P,
		int arc_size,
		int arc_d,
		int arc_d_low,
		...
		int verbose_level)
{
	...
	if (f_v) {
		cout << "geometry_global::arc_lifting1" << endl;
	}
	diophant *D = NULL;
	...
	P->arc_with_given_set_of_s_lines_diophant(
	...
	if (f_v) {
		cout << "geometry_global::arc_lifting1 done" << endl;
	}

}

void geometry_global::arc_lifting2(
		projective_space *P,
		int arc_size,
		int arc_d,
		int arc_d_low,
		...
		int verbose_level)
{
	...
	if (f_v) {
		cout << "geometry_global::arc_lifting2" << endl;
	}
	long int *t_lines;
	int nb_t_lines;
	...
	P->arc_with_two_given_line_sets_diophant(
	...
	FREE_lint(the_set_in);
	if (f_v) {
		cout << "geometry_global::arc_lifting2 done" << endl;
	}

}


void geometry_global::arc_lifting3(
		projective_space *P,
		int arc_size,
		int arc_d,
		int arc_d_low,
		...
		int verbose_level)
{
	...
	if (f_v) {
		cout << "geometry_global::arc_lifting3" << endl;
	}
	//int arc_size;
	//int arc_d;
	diophant *D = NULL;
	...
	P->arc_with_three_given_line_sets_diophant(
			the_set_in /* s_lines */, set_size_in /* nb_s_lines */, arc_s,
			t_lines, nb_t_lines, arc_t,
	...
	FREE_lint(the_set_in);
	if (f_v) {
		cout << "geometry_global::arc_lifting3 done" << endl;
	}
