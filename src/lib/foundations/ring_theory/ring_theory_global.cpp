		...
		long int rk0, long int rk1, int verbose_level)
{
...

	{
...

		{
			...
			if (f_v) {
				cout << "ring_theory_global::polynomial_division_with_report before division_with_remainder_numerically_with_report" << endl;
			}
			//report(ost, verbose_level);
			...
			if (f_v) {
				cout << "ring_theory_global::polynomial_division_with_report after division_with_remainder_numerically_with_report" << endl;
			}
		...
		std::string &input_file, long int rk1, int k, int verbose_level)
{
	...
	unipoly_domain D(F);
	{
...

		{
			...
			if (f_v) {
				cout << "ring_theory_global::polynomial_division_from_file_all_k_error_patterns_with_report before division_with_remainder_numerically_with_report" << endl;
			}
			//report(ost, verbose_level);
			...
			if (f_v) {
				cout << "ring_theory_global::polynomial_division_from_file_all_k_error_patterns_with_report after division_with_remainder_numerically_with_report" << endl;
			}
...
void ring_theory_global::number_of_conditions_satisfied(
		finite_field *F,
...
// creates homogeneous_polynomial_domain
{
	...
	if (f_v) {
		cout << "ring_theory_global::number_of_conditions_satisfied" << endl;
	}
	...
	HPD->init(F, variety_nb_vars, variety_degree,
	...
	if (f_v) {
		cout << "ring_theory_global::number_of_conditions_satisfied done" << endl;
	}
}


void ring_theory_global::create_intersection_of_zariski_open_sets(
		finite_field *F,
		std::string &variety_label_txt,
		std::string &variety_label_tex,
		int variety_nb_vars, int variety_degree,
...
// creates homogeneous_polynomial_domain
{
	...
	if (f_v) {
		cout << "ring_theory_global::create_intersection_of_zariski_open_sets done" << endl;
	}
}


void ring_theory_global::create_projective_variety(
		finite_field *F,
...
// creates homogeneous_polynomial_domain
{
	...
	if (f_v) {
		cout << "ring_theory_global::create_projective_variety" << endl;
	}
	...
	if (sz != HPD->get_nb_monomials()) {
		cout << "ring_theory_global::create_projective_variety "
	...
	if (f_v) {
		cout << "ring_theory_global::create_projective_variety done" << endl;
	}
}

void ring_theory_global::create_projective_curve(
		finite_field *F,
		std::string &variety_label_txt,
		std::string &variety_label_tex,
...
// creates homogeneous_polynomial_domain
{
	...
	if (f_v) {
		cout << "ring_theory_global::create_projective_curve" << endl;
	}
	...
	for (i = 0; i < nb_pts; i++) {
		...
		F->PG_element_rank_modified(v, 1, curve_nb_vars, c);
		Pts[i] = c;
		if (f_v) {
			cout << setw(4) << i << " : ";
	...
	if (f_v) {
		cout << "ring_theory_global::create_projective_curve done" << endl;
	}
}
...
void ring_theory_global::do_make_table_of_irreducible_polynomials(finite_field *F,
