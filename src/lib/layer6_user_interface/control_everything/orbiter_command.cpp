		...
		int argc, std::string *Argv, int &i, int verbose_level)
{
...

	{
		...
		layer6_user_interface::activities::interface_symbol_table *Interface_symbol_table;

		Interface_symbol_table = NEW_OBJECT(layer6_user_interface::activities::interface_symbol_table);
	...
	}
	{
		...
		layer6_user_interface::activities::interface_algebra *Interface_algebra;
		Interface_algebra = NEW_OBJECT(layer6_user_interface::activities::interface_algebra);
	...
	}
	{
		...
		layer6_user_interface::activities::interface_cryptography *Interface_cryptography;
		Interface_cryptography = NEW_OBJECT(layer6_user_interface::activities::interface_cryptography);
	...
	}
	{
		...
		layer6_user_interface::activities::interface_combinatorics *Interface_combinatorics;
		Interface_combinatorics = NEW_OBJECT(layer6_user_interface::activities::interface_combinatorics);
	...
	}
	{
		...
		layer6_user_interface::activities::interface_coding_theory *Interface_coding_theory;
		Interface_coding_theory = NEW_OBJECT(layer6_user_interface::activities::interface_coding_theory);
	...
	}
	{
		...
		layer6_user_interface::activities::interface_povray *Interface_povray;
		Interface_povray = NEW_OBJECT(layer6_user_interface::activities::interface_povray);
	...
	}
	{
		...
		layer6_user_interface::activities::interface_projective *Interface_projective;
		Interface_projective = NEW_OBJECT(layer6_user_interface::activities::interface_projective);
	...
	}
	{
		...
		layer6_user_interface::activities::interface_toolkit *Interface_toolkit;
		Interface_toolkit = NEW_OBJECT(layer6_user_interface::activities::interface_toolkit);
