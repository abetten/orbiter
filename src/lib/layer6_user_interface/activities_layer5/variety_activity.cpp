		...
		int verbose_level)
{
	...
	layer5_applications::canonical_form::canonical_form_classifier *Classifier;

	Classifier = NEW_OBJECT(layer5_applications::canonical_form::canonical_form_classifier);
	...
	layer5_applications::canonical_form::canonical_form_global Canonical_form_global;

	layer5_applications::canonical_form::classification_of_varieties_nauty *Classification_of_varieties_nauty;
