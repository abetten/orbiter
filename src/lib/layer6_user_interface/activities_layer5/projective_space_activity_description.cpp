	...
	for (i = 0; i < argc; i++) {
		...
		// 2:
			...
			sweep_surface_description =
					NEW_OBJECT(layer5_applications::applications_in_algebraic_geometry::cubic_surfaces_in_general::surface_create_description);
			if (f_v) {
				cout << "-sweep" << endl;
			}
		...
		// cubic surfaces:
			...
			if (f_v) {
				cout << "-classify_surfaces_through_arcs_and_trihedral_pairs "
						<< classify_surfaces_through_arcs_and_trihedral_pairs_draw_options_label << endl;
			}
		}
