		...
		int verbose_level)
{
	...
	layer5_applications::apps_combinatorics::design_create *DC = (layer5_applications::apps_combinatorics::design_create *) Design_object->DC;
...
// does not need DC. This should be an activity for the design_table
{
	...
	layer5_applications::apps_combinatorics::combinatorics_global Combi;
	layer5_applications::apps_combinatorics::design_tables *T;
		...
		int verbose_level)
{
	...
	layer5_applications::apps_combinatorics::large_set_classify *LS;

	LS = NEW_OBJECT(layer5_applications::apps_combinatorics::large_set_classify);
