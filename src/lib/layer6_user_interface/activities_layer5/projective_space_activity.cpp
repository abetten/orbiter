		...
		int verbose_level)
{
	...
	if (Descr->f_cheat_sheet) {
		...
		layer5_applications::applications_in_algebraic_geometry::cubic_surfaces_in_general::surface_domain_high_level SH;
		...
		cout << "projective_space_activity::perform_activity "
				"PA->canonical_form_of_code is disabled" << endl;
		exit(1);
#if 0
		if (f_v) {
			cout << "projective_space_activity::perform_activity "
		...
		layer5_applications::projective_geometry::projective_space_global G;
		...
		layer5_applications::applications_in_algebraic_geometry::cubic_surfaces_in_general::surface_domain_high_level D;
