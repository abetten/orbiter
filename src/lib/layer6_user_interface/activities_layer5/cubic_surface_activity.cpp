		...
		int verbose_level)
{
	...
	layer5_applications::orbits::orbits_create *Classification_of_arcs;
	...
	layer5_applications::applications_in_algebraic_geometry::cubic_surfaces_in_general::surface_object_with_group *SOA;
