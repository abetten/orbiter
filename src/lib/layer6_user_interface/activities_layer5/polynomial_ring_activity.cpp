		...
		int verbose_level)
{
	...
	if (Descr->f_cheat_sheet) {
		...
		layer5_applications::projective_geometry::ring_with_action *Ring_with_action;

		Ring_with_action = NEW_OBJECT(layer5_applications::projective_geometry::ring_with_action);
