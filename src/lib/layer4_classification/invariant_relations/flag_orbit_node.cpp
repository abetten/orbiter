		...
		std::ofstream &fp, int verbose_level)
{
	...
	fp.write((const char *) &downstep_primary_orbit, sizeof(int));
	fp.write((const char *) &downstep_secondary_orbit, sizeof(int));
	fp.write((const char *) &downstep_orbit_len, sizeof(int));
	fp.write((const char *) &upstep_primary_orbit, sizeof(int));
	fp.write((const char *) &upstep_secondary_orbit, sizeof(int));
	fp.write((const char *) &f_fusion_node, sizeof(int));
	if (f_fusion_node) {
		if (f_v) {
			cout << "flag_orbit_node::write_file f_fusion_node" << endl;
		}
		fp.write((const char *) &fusion_with, sizeof(int));
