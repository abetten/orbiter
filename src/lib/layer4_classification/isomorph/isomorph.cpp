...
isomorph::~isomorph()
{
...
#if 0
	if (f_v) {
		cout << "isomorph::~isomorph before deleting A" << endl;
		}
	if (A) {
		FREE_OBJECT(A);
		}
#endif
	if (f_v) {
		cout << "isomorph::~isomorph before deleting AA" << endl;
		}
	if (AA) {
		FREE_OBJECT(AA);
		AA = NULL;
...
#if 0
	if (f_v) {
		cout << "isomorph::~isomorph before deleting gen" << endl;
		}
	if (gen) {
		FREE_OBJECT(gen);
		gen = NULL;
	...
	if (f_v) {
		cout << "isomorph::~isomorph before deleting D1" << endl;
		}
	if (D1) {
		freeobject(D1);
		D1 = NULL;
	...
	if (f_v) {
		cout << "isomorph::~isomorph before deleting D2" << endl;
		}
	if (D2) {
		freeobject(D2);
		D2 = NULL;
	...
	if (f_tmp_data_has_been_allocated) {
		if (f_v) {
			cout << "isomorph::~isomorph before free_tmp_data" << endl;
			}
		free_tmp_data();
		}
	if (id_to_datref) {
