...
int interface_povray::scan1(int argc, const char **argv, int &i, int verbose_level)
{
	//int f_v = (verbose_level >= 1);
...
int interface_povray::scan2(int argc, const char **argv, int &i, int verbose_level)
{
	int f_v = (verbose_level >= 1);
