...
#ifndef SRC_LIB_LAYER5_TOP_LEVEL_USER_INTERFACE_ACTIVITIES_LAYER5_ACTIVITIES_LAYER5_H_
#define SRC_LIB_LAYER5_TOP_LEVEL_USER_INTERFACE_ACTIVITIES_LAYER5_ACTIVITIES_LAYER5_H_
...
public:
	...
	void init(
			user_interface::activities_layer5::cubic_surface_activity_description
				*Cubic_surface_activity_description,
			applications_in_algebraic_geometry::cubic_surfaces_in_general::surface_create *SC, int verbose_level);
	void perform_activity(
			other::orbiter_kernel_system::activity_output *&AO,
			int verbose_level);
...
public:
	...
	apps_algebra::element_processing_description *element_processing_descr;
...
public:
	...
	packings::packing_classify *Packing_classify;
...
public:
	...
	void init(
			quartic_curve_activity_description
				*Quartic_curve_activity_description,
				applications_in_algebraic_geometry::quartic_curves::quartic_curve_create *QC, int verbose_level);
	void perform_activity(
			other::orbiter_kernel_system::activity_output *&AO,
			int verbose_level);
...
public:
	...
	spreads::spread_create *Spread_create;
...
#endif /* SRC_LIB_LAYER5_TOP_LEVEL_USER_INTERFACE_ACTIVITIES_LAYER5_ACTIVITIES_LAYER5_H_ */
