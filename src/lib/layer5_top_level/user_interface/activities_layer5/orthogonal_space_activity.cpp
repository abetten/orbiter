		...
		int verbose_level)
{
	...
	if (Descr->f_cheat_sheet_orthogonal) {
	...
	else if (Descr->f_intersect_with_subspace) {
		cout << "orthogonal_space_activity::perform_activity "
	...
	else if (Descr->f_intersect_with_subspace_given_by_base) {

		cout << "orthogonal_space_activity::perform_activity "
				"intersect_with_subspace " << Descr->intersect_with_subspace_given_by_base_label << endl;
		...
		Get_lint_vector_from_label(
				Descr->intersect_with_subspace_given_by_base_label,
				Base_rk, sz, 0 /* verbose_level */);

		if (f_v) {
			cout << "orthogonal_space_activity::perform_activity "
					"The base points are: " << endl;
			Lint_vec_print(cout, Base_rk, sz);
			cout << endl;
		}
		...
		if (f_v) {
			cout << "orthogonal_space_activity::perform_activity "
					"before OA->intersection_with_subspace_basis_as_points" << endl;
		}
		OA->intersection_with_subspace_basis_as_points(
				Base_rk, sz,
				the_points, nb_points,
				verbose_level - 1);
		if (f_v) {
			cout << "orthogonal_space_activity::perform_activity "
					"after OA->intersection_with_subspace_basis_as_points" << endl;
			cout << "orthogonal_space_activity::perform_activity "
					"The number of singular points in the subspace is " << nb_points << endl;
