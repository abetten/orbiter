		...
		int argc, std::string *argv, int &i, int verbose_level)
{
	...
	if (ST.stringcmp(argv[i], "-finite_field_activity") == 0) {
		...
		Finite_field_activity_description =
				NEW_OBJECT(user_interface::activities_layer1::finite_field_activity_description);
		if (f_v) {
		...
		Polynomial_ring_activity_description =
				NEW_OBJECT(user_interface::activities_layer1::polynomial_ring_activity_description);
		if (f_v) {
		...
		Projective_space_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::projective_space_activity_description);
		if (f_v) {
		...
		Orthogonal_space_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::orthogonal_space_activity_description);
		if (f_v) {
		...
		Group_theoretic_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::group_theoretic_activity_description);
		if (f_v) {
		...
		Coding_theoretic_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::coding_theoretic_activity_description);
		if (f_v) {
		...
		Cubic_surface_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::cubic_surface_activity_description);
		if (f_v) {
		...
		Quartic_curve_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::quartic_curve_activity_description);
		if (f_v) {
		...
		Blt_set_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::blt_set_activity_description);
		if (f_v) {
		...
		Combinatorial_object_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::combinatorial_object_activity_description);
		if (f_v) {
		...
		Graph_theoretic_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::graph_theoretic_activity_description);
		if (f_v) {
		...
		Classification_of_cubic_surfaces_with_double_sixes_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::classification_of_cubic_surfaces_with_double_sixes_activity_description);
		if (f_v) {
		...
		Spread_table_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::spread_table_activity_description);
		if (f_v) {
		...
		Packing_classify_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::packing_classify_activity_description);
		if (f_v) {
		...
		Packing_was_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::packing_was_activity_description);
		if (f_v) {
		...
		Packing_was_fixpoints_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::packing_was_fixpoints_activity_description);
		if (f_v) {
		...
		Graph_classification_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::graph_classification_activity_description);
		if (f_v) {
		...
		Diophant_activity_description =
				NEW_OBJECT(user_interface::activities_layer1::diophant_activity_description);
		if (f_v) {
		...
		Design_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::design_activity_description);
		if (f_v) {
		...
		Large_set_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::large_set_activity_description);
		if (f_v) {
		...
		Large_set_was_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::large_set_was_activity_description);
		if (f_v) {
		...
		Symbolic_object_activity_description =
				NEW_OBJECT(user_interface::activities_layer1::symbolic_object_activity_description);
		if (f_v) {
		...
		Blt_set_classify_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::blt_set_classify_activity_description);
		if (f_v) {
		...
		Spread_classify_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::spread_classify_activity_description);
		if (f_v) {
		...
		Spread_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::spread_activity_description);
		if (f_v) {
		...
		Translation_plane_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::translation_plane_activity_description);
		if (f_v) {
		...
		Action_on_forms_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::action_on_forms_activity_description);
		if (f_v) {
		...
		Orbits_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::orbits_activity_description);
		if (f_v) {
		...
		Variety_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::variety_activity_description);
		if (f_v) {
		...
		Vector_ge_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::vector_ge_activity_description);
		if (f_v) {
		...
		Combo_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::combo_activity_description);
		if (f_v) {
		...
		Plesken_ring_activity_description =
				NEW_OBJECT(user_interface::activities_layer5::plesken_ring_activity_description);
		if (f_v) {
		...
		int verbose_level)
{
	...
	user_interface::activities_layer1::finite_field_activity FA;
		...
		int verbose_level)
{
	...
	user_interface::activities_layer5::projective_space_activity Activity;
		...
		int verbose_level)
{
	...
	user_interface::activities_layer5::orthogonal_space_activity Activity;
		...
		int verbose_level)
{
	...
	{
		user_interface::activities_layer5::group_theoretic_activity Activity;
		...
		int verbose_level)
{
	...
	{
		int i;
		user_interface::activities_layer5::coding_theoretic_activity Activity;
		...
		int verbose_level)
{
	...
	SC = (applications_in_algebraic_geometry::cubic_surfaces_in_general::surface_create *)
			Sym->Orbiter_top_level_session->get_object(Idx[0]);
	{
		user_interface::activities_layer5::cubic_surface_activity Activity;
		...
		int verbose_level)
{
	...
	QC = (applications_in_algebraic_geometry::quartic_curves::quartic_curve_create *)
			Sym->Orbiter_top_level_session->get_object(Idx[0]);
	{
		user_interface::activities_layer5::quartic_curve_activity Activity;
		...
		int verbose_level)
{
	...
	BC = (orthogonal_geometry_applications::BLT_set_create *)
			Sym->Orbiter_top_level_session->get_object(Idx[0]);
	{
		user_interface::activities_layer5::blt_set_activity Activity;
		...
		int verbose_level)
{
	...
	if (t == layer1_foundations::other::orbiter_kernel_system::symbol_table_object_type::t_geometric_object) {
		...
		GOC = (geometry::other_geometry::geometric_object_create *)
				Sym->Orbiter_top_level_session->get_object(Idx[0]);
		{
			user_interface::activities_layer5::combinatorial_object_activity Activity;
		...
		int verbose_level)
{
	...
	{
		user_interface::activities_layer5::classification_of_cubic_surfaces_with_double_sixes_activity
			Activity;
		...
		int verbose_level)
{
	...
	Spread_table_with_selection = (spreads::spread_table_with_selection *)
			Sym->Orbiter_top_level_session->get_object(Idx[0]);
	{
		user_interface::activities_layer5::spread_table_activity Activity;
		...
		int verbose_level)
{
	...
	P = (packings::packing_classify *)
			Sym->Orbiter_top_level_session->get_object(Idx[0]);
	{
		user_interface::activities_layer5::packing_classify_activity Activity;
		...
		int verbose_level)
{
	...
	PW = (packings::packing_was *)
			Sym->Orbiter_top_level_session->get_object(Idx[0]);
	{
		user_interface::activities_layer5::packing_was_activity Activity;
		...
		int verbose_level)
{
	...
	PWF = (packings::packing_was_fixpoints *)
			Sym->Orbiter_top_level_session->get_object(Idx[0]);
	{
		user_interface::activities_layer5::packing_was_fixpoints_activity Activity;
		...
		int verbose_level)
{
	...
	GC = (apps_graph_theory::graph_classify *)
			Sym->Orbiter_top_level_session->get_object(Idx[0]);
	{
		user_interface::activities_layer5::graph_classification_activity Activity;
		...
		int verbose_level)
{
	...
	Dio = (combinatorics::solvers::diophant_create *)
			Sym->Orbiter_top_level_session->get_object(Idx[0]);
	{
		user_interface::activities_layer1::diophant_activity Activity;
		...
		int verbose_level)
{
	...
	{
		user_interface::activities_layer5::design_activity Activity;
		...
		int verbose_level)
{
	...
	Large_set_classify = (apps_combinatorics::large_set_classify *)
			Sym->Orbiter_top_level_session->get_object(Idx[0]);
	{
		user_interface::activities_layer5::large_set_activity Activity;
		...
		int verbose_level)
{
	...
	LSW = (apps_combinatorics::large_set_was *)
			Sym->Orbiter_top_level_session->get_object(Idx[0]);
	{
		user_interface::activities_layer5::large_set_was_activity Activity;
		...
		int verbose_level)
{
	...
	f = (algebra::expression_parser::symbolic_object_builder *)
			Sym->Orbiter_top_level_session->get_object(Idx[0]);
	{
		user_interface::activities_layer1::symbolic_object_activity Activity;
		...
		int verbose_level)
{
			...
			Sym->Orbiter_top_level_session->get_object(Idx[0]);
	{
		...
		user_interface::activities_layer5::blt_set_classify_activity Activity;
		...
		int verbose_level)
{
			...
			Sym->Orbiter_top_level_session->get_object(Idx[0]);
	{
		...
		user_interface::activities_layer5::spread_classify_activity Activity;
		...
		int verbose_level)
{
			...
			Sym->Orbiter_top_level_session->get_object(Idx[0]);
	{
		...
		user_interface::activities_layer5::spread_activity Activity;
		...
		int verbose_level)
{
			...
			Sym->Orbiter_top_level_session->get_object(Idx[0]);
	{
		...
		user_interface::activities_layer5::translation_plane_activity Activity;
		...
		int verbose_level)
{
			...
			Sym->Orbiter_top_level_session->get_object(Idx[0]);
	{
		...
		user_interface::activities_layer5::action_on_forms_activity Activity;
		...
		int verbose_level)
{
			...
			Sym->Orbiter_top_level_session->get_object(Idx[0]);
	{
		...
		user_interface::activities_layer5::orbits_activity Activity;
		...
		int verbose_level)
{
	...
	}
	{
		...
		user_interface::activities_layer5::variety_activity Activity;
		...
		int verbose_level)
{
	...
	//vec = VB->V;
	{
		...
		user_interface::activities_layer5::vector_ge_activity Activity;
		...
		int verbose_level)
{
	...
	other::orbiter_kernel_system::activity_output *AO;
	{
		...
		user_interface::activities_layer5::combo_activity Activity;
		...
		int verbose_level)
{
	...
	//other::orbiter_kernel_system::activity_output *AO;
	{
		...
		user_interface::activities_layer5::plesken_ring_activity Activity;
