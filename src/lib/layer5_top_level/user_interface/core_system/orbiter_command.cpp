		...
		int argc, std::string *Argv, int &i, int verbose_level)
{
...

	{
		...
		user_interface::activities::interface_symbol_table *Interface_symbol_table;

		Interface_symbol_table = NEW_OBJECT(user_interface::activities::interface_symbol_table);
	...
	}
	{
		...
		user_interface::activities::interface_algebra *Interface_algebra;
		Interface_algebra = NEW_OBJECT(user_interface::activities::interface_algebra);
	...
	}
	{
		...
		user_interface::activities::interface_cryptography *Interface_cryptography;
		Interface_cryptography = NEW_OBJECT(user_interface::activities::interface_cryptography);
	...
	}
	{
		...
		user_interface::activities::interface_combinatorics *Interface_combinatorics;
		Interface_combinatorics = NEW_OBJECT(user_interface::activities::interface_combinatorics);
	...
	}
	{
		...
		user_interface::activities::interface_coding_theory *Interface_coding_theory;
		Interface_coding_theory = NEW_OBJECT(user_interface::activities::interface_coding_theory);
	...
	}
	{
		...
		user_interface::activities::interface_povray *Interface_povray;
		Interface_povray = NEW_OBJECT(user_interface::activities::interface_povray);
	...
	}
	{
		...
		user_interface::activities::interface_projective *Interface_projective;
		Interface_projective = NEW_OBJECT(user_interface::activities::interface_projective);
	...
	}
	{
		...
		user_interface::activities::interface_toolkit *Interface_toolkit;
		Interface_toolkit = NEW_OBJECT(user_interface::activities::interface_toolkit);
