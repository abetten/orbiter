...
#ifndef SRC_LIB_LAYER5_TOP_LEVEL_USER_INTERFACE_ACTIVITIES_ACTIVITIES_H_
#define SRC_LIB_LAYER5_TOP_LEVEL_USER_INTERFACE_ACTIVITIES_ACTIVITIES_H_
...
public:
	user_interface::core_system::orbiter_top_level_session *Orbiter_top_level_session;

	int f_define;
	user_interface::core_system::symbol_definition *Symbol_definition;
...
#endif /* SRC_LIB_LAYER5_TOP_LEVEL_USER_INTERFACE_ACTIVITIES_ACTIVITIES_H_ */
