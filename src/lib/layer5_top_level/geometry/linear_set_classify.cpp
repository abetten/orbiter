...
// Q = q^s and n = m * s
{
	...
	if (f_vv) {
		...
		AQ->Strong_gens->print_generators(cout, verbose_level - 1);
	...
	int verbose_level)
{
	...
	if (f_v) {
		...
		Strong_gens_previous->print_generators(cout, verbose_level - 1);
		...
		int verbose_level)
{
	...
	for (h = 0; h < nb_orbits; h++) {
		...
		Strong_gens2->print_generators(cout, verbose_level - 1);
