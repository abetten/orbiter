		...
		int verbose_level)
{
	...
	if (!Descr->f_without_group) {
		...
		A->Action_latex_interface->report(ost,
				false /* f_sims */, NULL,
...
void orthogonal_space_with_action::intersection_with_subspace_basis_as_points(
		...
		int verbose_level)
{
	...
	if (f_v) {
		cout << "orthogonal_space_with_action::intersection_with_subspace_basis_as_points " << endl;
	}
	...
	if (n != O->Quadratic_form->n) {
		cout << "orthogonal_space_with_action::intersection_with_subspace_basis_as_points "
				"error: the width of the matrix does not match with the orthogonal space" << endl;
		cout << "width = " << n << endl;
		cout << "dimension of orthogonal space = " << O->Quadratic_form->n << endl;
		exit(1);
	}

	if (f_v) {
		cout << "orthogonal_space_with_action::intersection_with_subspace_basis_as_points "
				"Intersecting with subspace generated by " << endl;
	...
	if (f_v) {
		cout << "orthogonal_space_with_action::intersection_with_subspace_basis_as_points "
				"before OA->O->intersection_with_subspace" << endl;
	}
	O->intersection_with_subspace(Basis, m,
			the_points, nb_points, verbose_level);

	if (f_v) {
		cout << "orthogonal_space_with_action::intersection_with_subspace_basis_as_points "
				"We found that the intersection contains " << nb_points << " points. " << endl;
	...
	Points = NEW_int(nb_points * n);

	P->unrank_points(
			Points, the_points, nb_points);

	if (f_v) {
		cout << "orthogonal_space_with_action::intersection_with_subspace_basis_as_points "
				"The points are: " << endl;
		Int_matrix_print(Points, nb_points, n);
	}
	...
	if (f_v) {
		cout << "orthogonal_space_with_action::intersection_with_subspace_basis_as_points done" << endl;
	}
}
