		...
		int verbose_level)
{
...

	{
		...
		title = "Automorphism Group of Graph";
		...
		int verbose_level)
{
	...
	Aut = Nauty.create_automorphism_group_of_colored_graph_ignoring_colors(CG, verbose_level);
	if (f_v) {
		cout << "graph_theory_apps::automorphism_group_bw "
...

	{
...

		{
			...
			if (f_v) {
				cout << "graph_theory_apps::automorphism_group_bw after report" << endl;
			}
