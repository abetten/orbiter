	...
	const BYTE **fname, INT *list_of_cases, INT nb_files, INT verbose_level)
{
	...
	if (f_v) {
		cout << "isomorph_read_solution_files_from_clique_finder_case_by_case" << endl;
		cout << "nb_files = " << nb_files << endl;
		cout << "prefix_iso = " << prefix_iso << endl;
		}
	...
	if (f_v) {
		cout << "isomorph_read_solution_files_from_clique_finder_case_by_case before Iso.init" << endl;
		}
	Iso.init(prefix_iso, A_base, A, gen, size, level, f_use_database_for_starter, 
		f_implicit_fusion, 0/*verbose_level - 2*/);
	if (f_v) {
		cout << "isomorph_read_solution_files_from_clique_finder_case_by_case after Iso.init" << endl;
		}
	

	if (f_v) {
		cout << "isomorph_read_solution_files_from_clique_finder_case_by_case before Iso.read_data_files_for_starter" << endl;
		}
	Iso.read_data_files_for_starter(level, prefix_classify, 0/*verbose_level - 4*/);
		// in isomorph.C
	if (f_v) {
		cout << "isomorph_read_solution_files_from_clique_finder_case_by_case after Iso.read_data_files_for_starter" << endl;
		}
	


	if (f_v) {
		cout << "isomorph_read_solution_files_from_clique_finder_case_by_case before Iso.count_solutions_from_clique_finder" << endl;
		}
	//INT f_get_statistics = FALSE;
	Iso.count_solutions_from_clique_finder_case_by_case(nb_files, list_of_cases, fname, /*f_get_statistics,*/ verbose_level - 1);
			// in isomorph_files.C
			//
			// now we know Iso.N, the number of solutions
			// from the clique finder
	...
	if (f_v) {
		cout << "isomorph_read_solution_files_from_clique_finder_case_by_case before Iso.read_solutions_from_clique_finder_case_by_case" << endl;
		}
	Iso.read_solutions_from_clique_finder_case_by_case(nb_files, list_of_cases, fname, verbose_level - 1);
			// in isomorph_files.C
	if (f_v) {
		cout << "isomorph_read_solution_files_from_clique_finder_case_by_case after Iso.read_solutions_from_clique_finder_case_by_case" << endl;
		}
	

	}
	if (f_v) {
		cout << "isomorph_read_solution_files_from_clique_finder_case_by_case done" << endl;
		}
	...
	INT f_save, INT verbose_level)
{
	...
	for (i = 0; i < identify_nb_files; i++) {
		...
		if (f_save) {
			...
			Iso.A_base->element_write_file_fp(Iso.transporter, f2, 0/* verbose_level*/);
