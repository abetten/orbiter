...
int main(int argc, char **argv)
{
	...
	if (f_code) {
		...
		make_generator_matrix(F, G, n, code_sz, code,
				0 /* verbose_level */);
		...
		d = F->code_minimum_distance(code_sz, code_sz - n,
				G + n * code_sz, 0 /* verbose_level */);
		...
		cout << "There are " << nb_codes_d << " codes with minimum "
				"distance " << d << ". They are:" << endl;
