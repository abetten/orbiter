...
problem2_q9:
	$(ORBITER) -v 1 \
		...
		-define C -quartic_curve -space P -by_normal_form '6,3,4,6,2,5' -bitmap -end

problem2_q11:
	$(ORBITER) -v 1 \
		-define F -finite_field -q 11 -end \
		-define P -projective_space -n 2 -field F -v 0 -end \
		-define C -quartic_curve -space P -by_normal_form '8,5,3,2,10,7' -bitmap -end

problem2_q13:
	$(ORBITER) -v 1 \
		-define F -finite_field -q 13 -end \
		-define P -projective_space -n 2 -field F -v 0 -end \
		-define C -quartic_curve -space P -by_normal_form '3,2,10,4,2,3' -bitmap -end

problem2_q17:
	$(ORBITER) -v 1 \
		-define F -finite_field -q 17 -end \
		-define P -projective_space -n 2 -field F -v 0 -end \
		-define C -quartic_curve -space P -by_normal_form '2,7,16,3,9,4' -bitmap -end
